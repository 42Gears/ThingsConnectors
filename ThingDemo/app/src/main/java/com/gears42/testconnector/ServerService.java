package com.gears42.testconnector;
...
public class ServerService extends Service {
    ...
    public void createThing() {
        ...
        BulbThing bulbThing=new BulbThing("BulbThing","Smart Bulb of Office","4242AB4242");
        listOfThings.put("4242AB4242",bulbThing);
            ...
            public void run() {
                try {
                    ...
                    if (listOfThings.size() != 0 && !ServerManager.isServerRunnning()) {
                        ...
                        serverManager.startServer(listOfThings, "List of Things", PORT, DEVICE_IP, rootPath, false, "com.gears42.thingdemo.RestartAppIntentReceiver");
                    } else {
